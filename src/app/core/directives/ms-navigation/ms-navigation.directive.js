(function ()
{
    ...
    function MsNavigationController($scope, msNavigationService)
    {
        ...
        //console.log('navigation', vm.navigation);
        // Methods
    ...
    /** @ngInject */
    function MsNavigationNodeController($scope, $element, $rootScope, $animate, $state, msNavigationService,$mdDialog)
    {
        var vm = this;
      ...
      function openModal(ev, node) {
        ...
        //console.log(vm.hasChildren);
        node.children.push(children);
        $scope.node = node;

        // vm.hasChildren = node.children.length > 0;
        init();
        //console.log('open modal', vm.hasChildren);
