...
.factory('utils', function($rootScope, $translate, $state, $sce, $http, apiUrl,$document,$timeout, $mdToast, $log) {
    $rootScope.baseUrl = apiUrl().baseUrl;
    return {
        settings: {},
        playlist: [],
        menulist: [],
        ...
        loadScript: function(url, callback) {
            ...
            if ($document[0].getElementById(filename)) return;
         ...
         * @returns {string}
         */
        setLogoUrl:function(logo_url){
            this.settings['logo_url'] = logo_url;
        },

        getLogoUrl: function() {
            var logo = this.getSetting('logo_url');
            return $rootScope.baseUrl+'assets/images/'+logo;
        },
        ...
        //get logo_url from settings (e.g name = 'logo_url')
        ...
        setPlayList: function (playlist) {
            // $log.log('setPlayList', playlist);
          this.playlist = playlist;
          $rootScope.$emit('addPlayList',{message: playlist})
        },
        ...
        setMenuList : function (menulist){
            ...
            // $rootScope.$emit('addMenuList', {message: menulist});
        },
        getMenuList : function () {
            return this.menulist;
        },
        setNewsTrackSubmenuList : function (tracks) {
            this.tracks = tracks;
		},
		getNewsTrackSubmenuList : function (tracks) {
			return this.tracks;
		},
        getShowable : function (item) {
            if (item.showable || item.showable == undefined) return true;
            else return false;
